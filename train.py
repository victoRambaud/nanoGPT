...
if __name__ == "__main__":
    ...
    def get_batch(split: str, blk_sz: Optional[int]=None, btch_sz: Optional[int]=None) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        if split == "train":
            ...
            data = np.memmap(os.path.join("/lustre/fswork/projects/rech/fku/uir17ua/dev/nanoGPT/data/pg19", "val_20.bin"), dtype=np.uint16, mode="r")
